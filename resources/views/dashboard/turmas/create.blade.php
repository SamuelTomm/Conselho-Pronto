    ...
    <div class="flex-1 w-full">
        <div class="bg-white/80 backdrop-blur-md border-b border-blue-100 sticky top-0 z-30 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Nova Turma</h1>
                    <p class="text-slate-600">Cadastre uma nova turma no sistema</p>
                </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-xl border-0">
                    <div class="bg-gradient-to-r from-blue-50 to-slate-50 border-b border-blue-100 p-6 rounded-t-lg">
                        ...
                        <p class="text-slate-600">Preencha os dados da turma</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="nome" 
                                        ...
                                        <option value="A" {{ old('nome') == 'A' ? 'selected' : '' }}>A</option>
                                        <option value="B" {{ old('nome') == 'B' ? 'selected' : '' }}>B</option>
                                        <option value="C" {{ old('nome') == 'C' ? 'selected' : '' }}>C</option>
                                        <option value="Magistério" {{ old('nome') == 'Magistério' ? 'selected' : '' }}>Magistério</option>
                                    </select>
                                    @error('nome')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="cor" 
                                        ...
                                        <option value="blue" {{ old('cor') == 'blue' ? 'selected' : '' }}>Azul</option>
                                        <option value="green" {{ old('cor') == 'green' ? 'selected' : '' }}>Verde</option>
                                        <option value="purple" {{ old('cor') == 'purple' ? 'selected' : '' }}>Roxo</option>
                                        <option value="orange" {{ old('cor') == 'orange' ? 'selected' : '' }}>Laranja</option>
                                        <option value="pink" {{ old('cor') == 'pink' ? 'selected' : '' }}>Rosa</option>
                                        <option value="emerald" {{ old('cor') == 'emerald' ? 'selected' : '' }}>Esmeralda</option>
                                    </select>
                                    @error('cor')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <textarea id="descricao" 
                                          ...
                                          placeholder="Descreva a turma, suas características e objetivos...">{{ old('descricao') }}</textarea>
                                @error('descricao')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
