                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="nivel" 
                                        ...
                                        <option value="Ensino Fundamental" {{ old('nivel') == 'Ensino Fundamental' ? 'selected' : '' }}>Ensino Fundamental</option>
                                        <option value="Ensino Médio" {{ old('nivel') == 'Ensino Médio' ? 'selected' : '' }}>Ensino Médio</option>
