    ...
    <div class="flex-1 w-full">
        <div class="bg-white/80 backdrop-blur-md border-b border-blue-100 sticky top-0 z-30 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Editar Nota</h1>
                    <p class="text-slate-600">Edite as informações da nota</p>
                </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-xl border-0">
                    <div class="bg-gradient-to-r from-blue-50 to-slate-50 border-b border-blue-100 p-6 rounded-t-lg">
                        ...
                        <p class="text-slate-600">Edite os dados da nota</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="aluno_id" 
                                        ...
                                        <option value="1" {{ old('aluno_id', $nota->aluno_id) == '1' ? 'selected' : '' }}>João Silva - 3º Ano A</option>
                                        <option value="2" {{ old('aluno_id', $nota->aluno_id) == '2' ? 'selected' : '' }}>Maria Santos - 3º Ano A</option>
                                        <option value="3" {{ old('aluno_id', $nota->aluno_id) == '3' ? 'selected' : '' }}>Pedro Costa - 2º Ano B</option>
                                        <option value="4" {{ old('aluno_id', $nota->aluno_id) == '4' ? 'selected' : '' }}>Ana Lima - 2º Ano B</option>
                                        <option value="5" {{ old('aluno_id', $nota->aluno_id) == '5' ? 'selected' : '' }}>Carlos Ferreira - 1º Ano C</option>
                                    </select>
                                    @error('aluno_id')
                                ...
                                <div>
                                    ...
                                    <select id="disciplina_id" 
                                        ...
                                        <option value="1" {{ old('disciplina_id', $nota->disciplina_id) == '1' ? 'selected' : '' }}>Matemática III</option>
                                        <option value="2" {{ old('disciplina_id', $nota->disciplina_id) == '2' ? 'selected' : '' }}>Física II</option>
                                        <option value="3" {{ old('disciplina_id', $nota->disciplina_id) == '3' ? 'selected' : '' }}>Programação I</option>
                                        <option value="4" {{ old('disciplina_id', $nota->disciplina_id) == '4' ? 'selected' : '' }}>História Contemporânea</option>
                                        <option value="5" {{ old('disciplina_id', $nota->disciplina_id) == '5' ? 'selected' : '' }}>Design Gráfico Digital</option>
                                    </select>
                                    @error('disciplina_id')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="turma_id" 
                                        ...
                                        <option value="1" {{ old('turma_id', $nota->turma_id) == '1' ? 'selected' : '' }}>3º Ano A</option>
                                        <option value="2" {{ old('turma_id', $nota->turma_id) == '2' ? 'selected' : '' }}>2º Ano B</option>
                                        <option value="3" {{ old('turma_id', $nota->turma_id) == '3' ? 'selected' : '' }}>1º Ano C</option>
                                        <option value="4" {{ old('turma_id', $nota->turma_id) == '4' ? 'selected' : '' }}>1º Técnico em Informática</option>
                                        <option value="5" {{ old('turma_id', $nota->turma_id) == '5' ? 'selected' : '' }}>2º Técnico em Design</option>
                                    </select>
                                    @error('turma_id')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="professor_id" 
                                        ...
                                        <option value="1" {{ old('professor_id', $nota->professor_id) == '1' ? 'selected' : '' }}>Maria Silva</option>
                                        <option value="2" {{ old('professor_id', $nota->professor_id) == '2' ? 'selected' : '' }}>João Santos</option>
                                        <option value="3" {{ old('professor_id', $nota->professor_id) == '3' ? 'selected' : '' }}>Ana Costa</option>
                                        <option value="4" {{ old('professor_id', $nota->professor_id) == '4' ? 'selected' : '' }}>Carlos Lima</option>
                                        <option value="5" {{ old('professor_id', $nota->professor_id) == '5' ? 'selected' : '' }}>Lucia Ferreira</option>
                                    </select>
                                    @error('professor_id')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="periodo" 
                                        ...
                                        <option value="2024/1" {{ old('periodo', $nota->periodo) == '2024/1' ? 'selected' : '' }}>2024/1</option>
                                        <option value="2024/2" {{ old('periodo', $nota->periodo) == '2024/2' ? 'selected' : '' }}>2024/2</option>
                                        <option value="2025/1" {{ old('periodo', $nota->periodo) == '2025/1' ? 'selected' : '' }}>2025/1</option>
                                    </select>
                                    @error('periodo')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="date" 
                                           id="data_avaliacao" 
                                           name="data_avaliacao" 
                                           value="{{ old('data_avaliacao', $nota->data_avaliacao) }}"
                                ...
                                <div>
                                    ...
                                    <select id="tipo_avaliacao" 
                                        ...
                                        <option value="Prova" {{ old('tipo_avaliacao', $nota->tipo_avaliacao) == 'Prova' ? 'selected' : '' }}>Prova</option>
                                        <option value="Trabalho" {{ old('tipo_avaliacao', $nota->tipo_avaliacao) == 'Trabalho' ? 'selected' : '' }}>Trabalho</option>
                                        <option value="Apresentação" {{ old('tipo_avaliacao', $nota->tipo_avaliacao) == 'Apresentação' ? 'selected' : '' }}>Apresentação</option>
                                        <option value="Projeto" {{ old('tipo_avaliacao', $nota->tipo_avaliacao) == 'Projeto' ? 'selected' : '' }}>Projeto</option>
                                        <option value="Participação" {{ old('tipo_avaliacao', $nota->tipo_avaliacao) == 'Participação' ? 'selected' : '' }}>Participação</option>
                                    </select>
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <textarea id="observacoes" 
                                          ...
                                          placeholder="Observações sobre a avaliação...">{{ old('observacoes', $nota->observacoes) }}</textarea>
                                @error('observacoes')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
