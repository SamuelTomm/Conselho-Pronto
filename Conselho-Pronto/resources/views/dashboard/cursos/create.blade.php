    ...
    <div class="flex-1 w-full">
        <div class="bg-white/80 backdrop-blur-md border-b border-blue-100 sticky top-0 z-30 px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Novo Curso</h1>
                    <p class="text-slate-600">Cadastre um novo curso no sistema</p>
                </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-xl border-0">
                    <div class="bg-gradient-to-r from-blue-50 to-slate-50 border-b border-blue-100 p-6 rounded-t-lg">
                        ...
                        <p class="text-slate-600">Preencha os dados do curso</p>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="tipo" 
                                        ...
                                        <option value="Básico" {{ old('tipo') == 'Básico' ? 'selected' : '' }}>Básico</option>
                                        <option value="Itinerário" {{ old('tipo') == 'Itinerário' ? 'selected' : '' }}>Itinerário</option>
                                        <option value="Técnico" {{ old('tipo') == 'Técnico' ? 'selected' : '' }}>Técnico</option>
                                    </select>
                                    @error('tipo')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
