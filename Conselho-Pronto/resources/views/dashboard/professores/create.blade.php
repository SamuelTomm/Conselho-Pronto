                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="role" 
                                        ...
                                        <option value="conselheiro" {{ old('role') == 'conselheiro' ? 'selected' : '' }}>Conselheiro</option>
                                    </select>
                                    @error('role')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="turmas" 
                                              ...
                                              placeholder="Liste as turmas atribuídas ao professor...">{{ old('turmas') }}</textarea>
                                    @error('turmas')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="disciplinas" 
                                              ...
                                              placeholder="Liste as disciplinas que o professor leciona...">{{ old('disciplinas') }}</textarea>
                                    @error('disciplinas')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
